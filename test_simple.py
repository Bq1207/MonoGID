...
def parse_args():
    ...
    parser.add_argument("--model_type",
                        ...
                        default="endodac")
    parser.add_argument("--use_bifpn",
                        type=str2bool,
                        help="use BiFPN for multi-scale feature fusion",
                        default=True)
    parser.add_argument("--bifpn_num_blocks",
                        type=int,
                        help="number of BiFPN blocks",
                        default=2)
    parser.add_argument("--use_geo_injection",
                        type=str2bool,
    ...
    parser.add_argument("--geo_type",
                        ...
                        help="geometry information type",
                        default="gradient")
    parser.add_argument("--geo_fusion_type",
                        type=str,
                        choices=["add", "gated"],
                        help="geometry fusion type",
                        default="gated")
...
def test_simple(args):
    ...
    if args.model_type == 'endodac':
        depther = endodac.endodac(
            ...
            bifpn_num_blocks=args.bifpn_num_blocks,
            use_geo_injection=args.use_geo_injection,
            geo_type=args.geo_type,
            geo_fusion_type=args.geo_fusion_type)
